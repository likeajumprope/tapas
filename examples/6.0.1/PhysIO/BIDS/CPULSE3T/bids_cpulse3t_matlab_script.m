...
physio.log_files.cardiac = {'sub-s998_task-random_run-99_physio.tsv'};
...
physio.scan_timing.sqpar.Nscans = 474;
physio.scan_timing.sqpar.Nprep = 0;
physio.scan_timing.sqpar.time_slice_to_slice = 0.090625;
physio.scan_timing.sqpar.onset_slice = 9;
...
physio.verbose.fig_output_file = 'physio.jpeg';
