...
matlabbatch{1}.spm.tools.physio.log_files.cardiac = {'Physio_20190101_120001_pppppppp-hhhh-yyyy-ssss-ioioioioioio_PULS.log'};
matlabbatch{1}.spm.tools.physio.log_files.respiration = {'Physio_20190101_120001_pppppppp-hhhh-yyyy-ssss-ioioioioioio_RESP.log'};
matlabbatch{1}.spm.tools.physio.log_files.scan_timing = {'Physio_20190101_120001_pppppppp-hhhh-yyyy-ssss-ioioioioioio_Info.log'};
