...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.physio.save_dir = {'C:\Users\kasperla\polybox\Shared\PhysioUserData\87-siemens-dicom-biopac-multirun-timing-github-issue-55\set1_puls_resp\physio_out_align_last'};
matlabbatch{1}.spm.tools.physio.log_files.vendor = 'Siemens';
matlabbatch{1}.spm.tools.physio.log_files.cardiac = {'C:\Users\kasperla\polybox\Shared\PhysioUserData\87-siemens-dicom-biopac-multirun-timing-github-issue-55\set1_puls_resp\20191023_V02.puls'};
matlabbatch{1}.spm.tools.physio.log_files.respiration = {'C:\Users\kasperla\polybox\Shared\PhysioUserData\87-siemens-dicom-biopac-multirun-timing-github-issue-55\set1_puls_resp\20191023_V02.resp'};
matlabbatch{1}.spm.tools.physio.log_files.scan_timing = {'C:\Users\kasperla\polybox\Shared\PhysioUserData\87-siemens-dicom-biopac-multirun-timing-github-issue-55\set1_puls_resp\MR.27842.1611'};
